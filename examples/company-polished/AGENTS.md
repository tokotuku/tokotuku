# Company Polished — Karsa project instructions

This project was scaffolded with `create-karsa`. It is an Astro company profile
and admin app assembled from Karsa modules and running on Cloudflare.
