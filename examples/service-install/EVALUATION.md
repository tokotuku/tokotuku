...
- package.json declares @karsa/booking, @karsa/catalog, and @karsa/orders alongside scaffold dependencies.
- karsa.migrations.json reports nextSequence 7 with auth:1, catalog:3, orders:2, and booking:1; migrations/ contains 0000_auth_init.sql through 0006_booking_init.sql.
- src/pages contains only index.astro, which renders the packaged SiteHome, and robots.txt.ts; src/theme, seed, and public are absent.
...
- RUN-METADATA.json identifies the generator as gpt-5.6-luna with max reasoning effort.
