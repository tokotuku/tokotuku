...
- src/pages/index.astro composes packaged Takontuku UI components and uses semantic --tk-* styling with a max-width: 760px responsive breakpoint.
...
- Uses Takontuku Layout, StoreHeader, StoreFooter, and Card components with semantic --tk-* tokens.
