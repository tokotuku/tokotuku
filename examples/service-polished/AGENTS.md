# Service Polished — Karsa project instructions

This project was scaffolded with `create-karsa`. It is an Astro service catalog,
booking, and admin app assembled from Karsa modules and running on Cloudflare.
...
- Put site-specific starting data in `seed/` and load it with `bunx karsa db seed`.
...
Use the installed Karsa skills for site-wide builds, UI, modules, and data work. Make
