...
takontuku({
  brand: {
    ...
    auth: { backgroundImage: "/images/auth.webp" },
...
The storefront home page and admin dashboard are assembled from module contributions, not
from a page you edit. Modules add sections and widgets through
...
navigation. To add your own section, contribute it from a module rather than copying the
packaged page — see the `takontuku-modules` skill.
